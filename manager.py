...
class Manager(QThread):
    ...
    def add_devices(self):
        ...
        if self.SIMULATE_HARDWARE:
            ...
            self.Forward_Power_Meter = PowerMeter(config=self.config, device_key= 'Forward_Meter')
            self.Reflected_Power_Meter = PowerMeter(config=self.config, device_key='Reflected_Meter')
