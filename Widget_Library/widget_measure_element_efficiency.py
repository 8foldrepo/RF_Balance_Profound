...
class Ui_Form_2(object):
    ...
    def retranslateUi(self, Form_2):
        ...
        self.RFB_CYCLES_FIELD.setToolTip(
            _translate("Form_2", "<html><head/><body><p><span style=\" font-size:12pt;\">A\n"
        ...
        self.ELEMENT_SELECTION_FIELD.setToolTip(
            _translate("Form_2", "<html><head/><body><p><span style=\" font-size:12pt;\">Select\n"
        ...
        self.OPTIONS_SELECTION_FIELD.setToolTip(
            _translate("Form_2", "<html><head/><body><p><span style=\" font-size:10pt;\n"
        ...
        self.data_directory_hint.setText(
            _translate("Form_2", "To manually set directory, change storage location mode to \"other directory\"\n"
                                 "                        "))
