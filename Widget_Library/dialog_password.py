...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.access_level_combo.setItemText(1, _translate("Dialog", "Engineer"))
        self.access_level_combo.setItemText(2, _translate("Dialog", "Administrator"))
