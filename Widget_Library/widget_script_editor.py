...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.script_cmd_dropdown.setGeometry(QtCore.QRect(20, 70, 221, 31))
        font = QtGui.QFont()
        ...
        self.add_cmd_to_script_button.setGeometry(QtCore.QRect(250, 70, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.script_command_buttons.setGeometry(QtCore.QRect(10, 170, 91, 291))
        ...
        self.label_132.setGeometry(QtCore.QRect(20, 40, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_132.setFont(font)
        self.label_132.setObjectName("label_132")
        self.groupBox = QtWidgets.QGroupBox(Form)
        self.groupBox.setGeometry(QtCore.QRect(440, 60, 271, 61))
        ...
        self.label.setGeometry(QtCore.QRect(10, 10, 765, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:10pt;\">This tab allows you to change task order, delete tasks, add tasks, save/create scripts, and change/set individual variables within tasks</span></p></body></html>"))
