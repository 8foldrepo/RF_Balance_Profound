...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.tooltip, 0, 0, 1, 1)
        ...
        self.label_108 = QtWidgets.QLabel(self.verticalWidget_4)
        self.label_108.setObjectName("label_108")
        self.verticalLayout_7.addWidget(self.label_108)
        self.power_w_field_2 = QtWidgets.QLineEdit(self.verticalWidget_4)
        self.power_w_field_2.setEnabled(False)
        self.power_w_field_2.setObjectName("power_w_field_2")
        self.verticalLayout_7.addWidget(self.power_w_field_2)
        ...
        self.rfb_results_combined_2 = QtWidgets.QFrame(Form)
        ...
        self.rfb_results_off = QtWidgets.QFrame(Form)
        ...
        self.rfb_results_on = QtWidgets.QFrame(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addLayout(self.gridLayout_23, 1, 0, 1, 1)
...
"                "))
        ...
        self.power_w_field_2.setToolTip(_translate("Form", "<html><head/><body><p>The acoustic power above divided by the difference between forward and reflected electrical power</p><p><br/></p></body></html>"))
