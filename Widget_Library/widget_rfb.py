...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.eff_percent_field = QtWidgets.QLineEdit(self.verticalWidget_4)
        self.eff_percent_field.setEnabled(False)
        self.eff_percent_field.setObjectName("eff_percent_field")
        self.verticalLayout_7.addWidget(self.eff_percent_field)
