...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.tooltip.setToolTip(_translate("Form",
                                           "This tab shows the data captured by the radiation force balance (RFB) and organizes the information into a grid and graph fashion, with a graph legend to explain what various lines represent"))
