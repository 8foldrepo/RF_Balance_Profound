...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.oscilloscope_scale_us_label = QtWidgets.QLabel(self.gridFrame_9)
        self.oscilloscope_scale_us_label.setMinimumSize(QtCore.QSize(0, 20))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.oscilloscope_scale_us_label.setFont(font)
        self.oscilloscope_scale_us_label.setObjectName("oscilloscope_scale_us_label")
        self.gridLayout_21.addWidget(self.oscilloscope_scale_us_label, 2, 0, 1, 1)
        ...
        self.oscilloscope_offset_us_label = QtWidgets.QLabel(self.gridFrame_9)
        self.oscilloscope_offset_us_label.setMinimumSize(QtCore.QSize(0, 20))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.oscilloscope_offset_us_label.setFont(font)
        self.oscilloscope_offset_us_label.setObjectName("oscilloscope_offset_us_label")
        self.gridLayout_21.addWidget(self.oscilloscope_offset_us_label, 4, 0, 1, 1)
        self.oscilloscope_offset_us = QtWidgets.QDoubleSpinBox(self.gridFrame_9)
        self.oscilloscope_offset_us.setMinimumSize(QtCore.QSize(0, 20))
        self.oscilloscope_offset_us.setMaximumSize(QtCore.QSize(50, 40))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.oscilloscope_offset_us.setFont(font)
        self.oscilloscope_offset_us.setMinimum(-99999999999999.0)
        self.oscilloscope_offset_us.setMaximum(9999999999999.0)
        self.oscilloscope_offset_us.setObjectName("oscilloscope_offset_us")
        self.gridLayout_21.addWidget(self.oscilloscope_offset_us, 4, 1, 1, 1)
        self.oscilloscope_scale_us = QtWidgets.QDoubleSpinBox(self.gridFrame_9)
        self.oscilloscope_scale_us.setMinimumSize(QtCore.QSize(0, 20))
        self.oscilloscope_scale_us.setMaximumSize(QtCore.QSize(50, 40))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.oscilloscope_scale_us.setFont(font)
        self.oscilloscope_scale_us.setMinimum(-99999999999999.0)
        self.oscilloscope_scale_us.setMaximum(9999999999999.0)
        self.oscilloscope_scale_us.setObjectName("oscilloscope_scale_us")
        self.gridLayout_21.addWidget(self.oscilloscope_scale_us, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.oscilloscope_scale_us_label.setText(_translate("Form", "Scale (us/div)"))
        self.label_95.setText(_translate("Form", "Oscilloscope timebase"))
        self.oscilloscope_offset_us_label.setText(_translate("Form", "Offset (us)"))
