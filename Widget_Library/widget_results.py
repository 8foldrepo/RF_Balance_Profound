...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1140, 608)
        self.tabWidget_2 = QtWidgets.QTabWidget(Form)
        self.tabWidget_2.setGeometry(QtCore.QRect(10, 10, 1061, 581))
        ...
        self.results_table.setGeometry(QtCore.QRect(10, 60, 971, 341))
        ...
        item = QtWidgets.QTableWidgetItem()
        self.results_table.setItem(0, 16, item)
        self.results_table.horizontalHeader().setDefaultSectionSize(59)
    ...
    def retranslateUi(self, Form):
        ...
        item = self.results_table.item(0, 16)
        item.setText(_translate("Form", "ertwetr"))
