...
"selection-background-color:rgb(85, 170, 255);")
    ...
    def retranslateUi(self, config_func_generator):
        ...
        self.ampl_doublespin.setToolTip(_translate("config_func_generator", "<html><head/><body><p align=\"justify\">Typical test case is 100mV (less than what is used clinically). Limit of the power amplifier is 1000 mV, with a 10x attenautor the limit raises to 10 Vpp (10,000 mVpp)</p></body></html>"))
        ...
        self.set_freq_opt_combo.setToolTip(_translate("config_func_generator", "<html><head/><body><p><span style=\" font-size:10pt;\n"
