...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.script_step_view = QtWidgets.QTreeView(self.centralwidget)
        ...
        self.tabWidget.setMinimumSize(QtCore.QSize(640, 680))
        ...
        self.verticalWidget_4.setGeometry(QtCore.QRect(40, 50, 80, 141))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(140, 40, 311, 151))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.results_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.results_layout.setContentsMargins(0, 0, 0, 0)
        self.results_layout.setObjectName("results_layout")
        self.label_117 = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        ...
        self.results_frame = QtWidgets.QFrame(self.verticalLayoutWidget_2)
        self.results_frame.setFrameShape(QtWidgets.QFrame.Box)
        self.results_frame.setFrameShadow(QtWidgets.QFrame.Plain)
        self.results_frame.setObjectName("results_frame")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.results_frame)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 309, 137))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.rfb_results_info = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.rfb_results_info.setContentsMargins(0, 0, 0, 0)
        self.rfb_results_info.setObjectName("rfb_results_info")
        self.verticalLayout_15 = QtWidgets.QVBoxLayout()
        self.verticalLayout_15.setContentsMargins(-1, -1, -1, 0)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.label_118 = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.label_118.setMaximumSize(QtCore.QSize(16777215, 9))
        self.label_118.setObjectName("label_118")
        self.verticalLayout_15.addWidget(self.label_118)
        self.power_on_frame = QtWidgets.QFrame(self.horizontalLayoutWidget)
        self.power_on_frame.setFrameShape(QtWidgets.QFrame.Box)
        self.power_on_frame.setFrameShadow(QtWidgets.QFrame.Plain)
        self.power_on_frame.setLineWidth(1)
        self.power_on_frame.setObjectName("power_on_frame")
        self.rfb_results_on = QtWidgets.QWidget(self.power_on_frame)
        self.rfb_results_on.setGeometry(QtCore.QRect(5, 3, 61, 122))
        ...
        self.verticalLayout_15.addWidget(self.power_on_frame)
        ...
        self.rfb_results_off = QtWidgets.QWidget(self.frame_3)
        self.rfb_results_off.setGeometry(QtCore.QRect(0, 0, 71, 123))
        ...
        self.label_120 = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.label_120.setMaximumSize(QtCore.QSize(16777215, 9))
        self.label_120.setObjectName("label_120")
        self.verticalLayout_13.addWidget(self.label_120)
        self.rfb_combined_frame = QtWidgets.QFrame(self.horizontalLayoutWidget)
        self.rfb_combined_frame.setFrameShape(QtWidgets.QFrame.Box)
        self.rfb_combined_frame.setFrameShadow(QtWidgets.QFrame.Plain)
        self.rfb_combined_frame.setObjectName("rfb_combined_frame")
        self.rfb_results_combined = QtWidgets.QWidget(self.rfb_combined_frame)
        self.rfb_results_combined.setGeometry(QtCore.QRect(0, 0, 71, 123))
        ...
        self.total_uc_spinbox_combined.setMaximumSize(QtCore.QSize(80, 16777215))
        ...
        self.verticalLayout_13.addWidget(self.rfb_combined_frame)
        self.rfb_results_info.addLayout(self.verticalLayout_13)
        self.verticalLayout_16 = QtWidgets.QVBoxLayout()
        self.verticalLayout_16.setSpacing(0)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.label_121 = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.label_121.setMaximumSize(QtCore.QSize(16777215, 9))
        self.label_121.setObjectName("label_121")
        self.verticalLayout_16.addWidget(self.label_121)
        self.rf_elec_pwr_frame = QtWidgets.QFrame(self.horizontalLayoutWidget)
        self.rf_elec_pwr_frame.setMaximumSize(QtCore.QSize(80, 77))
        self.rf_elec_pwr_frame.setFrameShape(QtWidgets.QFrame.Box)
        self.rf_elec_pwr_frame.setFrameShadow(QtWidgets.QFrame.Plain)
        self.rf_elec_pwr_frame.setObjectName("rf_elec_pwr_frame")
        self.rf_elec_pwr = QtWidgets.QWidget(self.rf_elec_pwr_frame)
        self.rf_elec_pwr.setGeometry(QtCore.QRect(-3, -4, 80, 80))
        self.rf_elec_pwr.setMaximumSize(QtCore.QSize(80, 80))
        self.rf_elec_pwr.setAutoFillBackground(False)
        self.rf_elec_pwr.setObjectName("rf_elec_pwr")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.rf_elec_pwr)
        self.verticalLayout_11.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.label_115 = QtWidgets.QLabel(self.rf_elec_pwr)
        self.label_115.setMaximumSize(QtCore.QSize(16777215, 10))
        self.label_115.setObjectName("label_115")
        self.verticalLayout_11.addWidget(self.label_115)
        self.pf_spinbox = QtWidgets.QSpinBox(self.rf_elec_pwr)
        ...
        self.verticalLayout_11.addWidget(self.pf_spinbox)
        self.label_116 = QtWidgets.QLabel(self.rf_elec_pwr)
        self.label_116.setMaximumSize(QtCore.QSize(16777215, 10))
        self.label_116.setObjectName("label_116")
        self.verticalLayout_11.addWidget(self.label_116)
        self.pr_spinbox = QtWidgets.QSpinBox(self.rf_elec_pwr)
        ...
        self.verticalLayout_11.addWidget(self.pr_spinbox)
        self.verticalLayout_16.addWidget(self.rf_elec_pwr_frame)
        self.rfb_results_info.addLayout(self.verticalLayout_16)
        self.results_layout.addWidget(self.results_frame)
        self.graphicsView = QtWidgets.QGraphicsView(self.tab_3)
        self.graphicsView.setGeometry(QtCore.QRect(310, 340, 256, 192))
        ...
        self.gridLayout_8 = QtWidgets.QGridLayout(self.scriptlog_tab)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.script_log = QtWidgets.QColumnView(self.scriptlog_tab)
        self.script_log.setObjectName("script_log")
        self.gridLayout_8.addWidget(self.script_log, 0, 0, 1, 1)
        ...
        self.reset_zero_button.setGeometry(QtCore.QRect(30, 470, 101, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_121.setText(_translate("MainWindow", "RF Electrical power"))
