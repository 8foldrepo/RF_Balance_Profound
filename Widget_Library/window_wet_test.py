...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rfb_led = QtWidgets.QWidget(self.widget)
        self.rfb_led.setMaximumSize(QtCore.QSize(100, 16777215))
        self.rfb_led.setObjectName("rfb_led")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.rfb_led)
        ...
        self.scope_led = QtWidgets.QWidget(self.widget)
        self.scope_led.setMaximumSize(QtCore.QSize(100, 16777215))
        self.scope_led.setObjectName("scope_led")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.scope_led)
        ...
        self.fgen_led = QtWidgets.QWidget(self.widget)
        self.fgen_led.setMaximumSize(QtCore.QSize(100, 16777215))
        self.fgen_led.setObjectName("fgen_led")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.fgen_led)
        ...
        self.tcouple_led = QtWidgets.QWidget(self.widget)
        self.tcouple_led.setMaximumSize(QtCore.QSize(100, 16777215))
        self.tcouple_led.setObjectName("tcouple_led")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.tcouple_led)
        self.motion_led = QtWidgets.QWidget(self.widget)
        self.motion_led.setMaximumSize(QtCore.QSize(100, 16777215))
        self.motion_led.setObjectName("motion_led")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.motion_led)
        self.powermeters_led = QtWidgets.QWidget(self.widget)
        self.powermeters_led.setMaximumSize(QtCore.QSize(100, 16777215))
        self.powermeters_led.setObjectName("powermeters_led")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.powermeters_led)
        self.wtfib_led = QtWidgets.QWidget(self.widget)
        self.wtfib_led.setMaximumSize(QtCore.QSize(100, 16777215))
        self.wtfib_led.setObjectName("wtfib_led")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.wtfib_led)
        self.dio_led = QtWidgets.QWidget(self.widget)
        self.dio_led.setMaximumSize(QtCore.QSize(100, 16777215))
        self.dio_led.setObjectName("dio_led")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.dio_led)
