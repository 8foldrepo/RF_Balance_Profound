...
class Ui_FIND_ELEMENT_WIDGET(object):
    def setupUi(self, FIND_ELEMENT_WIDGET):
        ...
        self.X_INCREMENT_FIELD.setDecimals(2)
        ...
        self.X_INCREMENT_FIELD.setProperty("value", 0.25)
        ...
        self.THETA_INCREMENT_FIELD.setDecimals(2)
        self.THETA_INCREMENT_FIELD.setMinimum(-360.0)
        self.THETA_INCREMENT_FIELD.setMaximum(360.0)
        self.THETA_INCREMENT_FIELD.setSingleStep(0.1)
        self.THETA_INCREMENT_FIELD.setProperty("value", -0.4)
        ...
        self.X_PNT_FIELD.setMaximum(1000)
        self.X_PNT_FIELD.setProperty("value", 21)
        ...
        self.THETA_PNT_FIELD.setProperty("value", 41)
        ...
        self.OSCOPE_AUTO_CHECKBOX.setChecked(True)
        ...
        self.FREQANG_BURST_FIELD.setProperty("value", 50.0)
        ...
        self.FREQANG_FREQ_FIELD.setProperty("value", 4.4)
        ...
        self.FREQANG_VOLT_FIELD.setDecimals(4)
        ...
        self.FREQANG_VOLT_FIELD.setProperty("value", 50.0)
    ...
    def retranslateUi(self, FIND_ELEMENT_WIDGET):
        ...
        self.OSCOPE_AQTYPE_FIELD.setToolTip(_translate("FIND_ELEMENT_WIDGET", "<html><head/><body><p><span style=\" font-size:10pt; text-decoration: underline;\">Selections Available:</span></p><p>- Single Waveform </p><p>- N Averaged Waveform</p></body></html>"))
        ...
        self.OSCOPE_SAMPLES_FIELD.setCurrentText(_translate("FIND_ELEMENT_WIDGET", "16 Averages"))
        ...
        self.OSCOPE_DATASTORE_FIELD.setToolTip(_translate("FIND_ELEMENT_WIDGET", "<html><head/><body><p><span style=\" font-size:10pt; text-decoration: underline;\">Selections Available:</span></p><p>- Do not store</p><p>- Store profiles only</p><p>- Store entire waveform</p></body></html> "))
        ...
        self.FREQANG_PRESET_FIELD.setToolTip(_translate("FIND_ELEMENT_WIDGET", "<html><head/><body><p><span style=\" font-size:10pt; text-decoration: underline;\">Selections Available:</span></p><p>- From config cluster </p><p>- Element pk low frequency</p><p>- Element pk high frequency</p><p>- Common low frequency</p><p>- Common high frequency</p></body></html>"))
        self.FREQANG_PRESET_FIELD.setCurrentText(_translate("FIND_ELEMENT_WIDGET", "Common low frequency"))
