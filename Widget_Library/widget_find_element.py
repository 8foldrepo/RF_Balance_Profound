...
class Ui_FIND_ELEMENT_WIDGET(object):
    def setupUi(self, FIND_ELEMENT_WIDGET):
        ...
        self.X_INCREMENT_FIELD.setSingleStep(0.05)
...
"                    "))
        ...
        self.ELEMENT_SELECTION_FIELD.setItemText(3, _translate("FIND_ELEMENT_WIDGET", "Element 4"))
        self.ELEMENT_SELECTION_FIELD.setItemText(4, _translate("FIND_ELEMENT_WIDGET", "Element 5"))
        self.ELEMENT_SELECTION_FIELD.setItemText(5, _translate("FIND_ELEMENT_WIDGET", "Element 6"))
        self.ELEMENT_SELECTION_FIELD.setItemText(6, _translate("FIND_ELEMENT_WIDGET", "Element 7"))
        self.ELEMENT_SELECTION_FIELD.setItemText(7, _translate("FIND_ELEMENT_WIDGET", "Element 8"))
        self.ELEMENT_SELECTION_FIELD.setItemText(8, _translate("FIND_ELEMENT_WIDGET", "Element 9"))
        self.ELEMENT_SELECTION_FIELD.setItemText(9, _translate("FIND_ELEMENT_WIDGET", "Element 10"))
...
"                    "))
        ...
        self.OSCOPE_SAMPLES_FIELD.setCurrentText(_translate("FIND_ELEMENT_WIDGET", "2 Averages"))
