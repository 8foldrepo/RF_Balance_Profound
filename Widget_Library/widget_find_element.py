...
class Ui_FIND_ELEMENT_WIDGET(object):
    def setupUi(self, FIND_ELEMENT_WIDGET):
        ...
        self.THETA_INCREMENT_FIELD_2 = QtWidgets.QDoubleSpinBox(self.frame)
        self.THETA_INCREMENT_FIELD_2.setGeometry(QtCore.QRect(300, 70, 115, 20))
        self.THETA_INCREMENT_FIELD_2.setToolTip("")
        self.THETA_INCREMENT_FIELD_2.setStatusTip("")
        self.THETA_INCREMENT_FIELD_2.setWhatsThis("")
        self.THETA_INCREMENT_FIELD_2.setPrefix("")
        self.THETA_INCREMENT_FIELD_2.setDecimals(0)
        self.THETA_INCREMENT_FIELD_2.setMinimum(-360.0)
        self.THETA_INCREMENT_FIELD_2.setMaximum(360.0)
        self.THETA_INCREMENT_FIELD_2.setSingleStep(1.0)
        self.THETA_INCREMENT_FIELD_2.setObjectName("THETA_INCREMENT_FIELD_2")
        self.THETA_INCREMENT_FIELD = QtWidgets.QLabel(self.frame)
        self.THETA_INCREMENT_FIELD.setGeometry(QtCore.QRect(210, 70, 111, 16))
        self.THETA_INCREMENT_FIELD.setObjectName("THETA_INCREMENT_FIELD")
        self.X_PNT_FIELD = QtWidgets.QDoubleSpinBox(self.frame)
        ...
        self.X_PNT_FIELD.setPrefix("")
        self.X_PNT_FIELD.setDecimals(4)
        self.X_PNT_FIELD.setMinimum(-1000000.0)
        self.X_PNT_FIELD.setMaximum(1000000.0)
        self.X_PNT_FIELD.setSingleStep(0.0001)
        ...
        self.THETA_PNT_FIELD = QtWidgets.QDoubleSpinBox(self.frame)
        ...
        self.THETA_PNT_FIELD.setPrefix("")
        self.THETA_PNT_FIELD.setDecimals(4)
        self.THETA_PNT_FIELD.setMinimum(-1000000.0)
        self.THETA_PNT_FIELD.setMaximum(1000000.0)
        self.THETA_PNT_FIELD.setSingleStep(0.0001)
    ...
    def retranslateUi(self, FIND_ELEMENT_WIDGET):
        ...
        self.label.setText(_translate("FIND_ELEMENT_WIDGET", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; text-decoration: underline;\">Element Positioning</span></p></body></html>"))
        ...
        self.THETA_INCREMENT_FIELD_2.setSuffix(_translate("FIND_ELEMENT_WIDGET", " Degrees"))
        self.THETA_INCREMENT_FIELD.setText(_translate("FIND_ELEMENT_WIDGET", "<html><head/><body><p>Theta Increment:</p></body></html>"))
        self.X_PNT_FIELD.setSuffix(_translate("FIND_ELEMENT_WIDGET", " Pts"))
        ...
        self.THETA_PNT_FIELD.setSuffix(_translate("FIND_ELEMENT_WIDGET", " Pts"))
        self.label_4.setText(_translate("FIND_ELEMENT_WIDGET", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; text-decoration: underline;\">Oscilliscope Parameters</span></p></body></html>"))
        ...
        self.OSCOPE_AQTYPE_FIELD.setItemText(0, _translate("FIND_ELEMENT_WIDGET", "N Averaged"))
        self.OSCOPE_AQTYPE_FIELD.setItemText(1, _translate("FIND_ELEMENT_WIDGET", "Type 2"))
        self.OSCOPE_AQTYPE_FIELD.setItemText(2, _translate("FIND_ELEMENT_WIDGET", "Type 3"))
        ...
        self.OSCOPE_DATASTORE_FIELD.setItemText(0, _translate("FIND_ELEMENT_WIDGET", "Stored"))
        self.OSCOPE_DATASTORE_FIELD.setItemText(1, _translate("FIND_ELEMENT_WIDGET", "Not Stored"))
        self.OSCOPE_DATASTORE_FIELD.setItemText(2, _translate("FIND_ELEMENT_WIDGET", "Data 3"))
        ...
        self.OSCOPE_DATALOC_FIELD.setItemText(1, _translate("FIND_ELEMENT_WIDGET", "Results 2"))
        self.OSCOPE_DATALOC_FIELD.setItemText(2, _translate("FIND_ELEMENT_WIDGET", "Results 3"))
        ...
        self.label_15.setText(_translate("FIND_ELEMENT_WIDGET", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; text-decoration: underline;\">Frequency &amp; Angle</span></p></body></html>"))
        self.label_16.setText(_translate("FIND_ELEMENT_WIDGET", "Frequency Preset:"))
        self.FREQANG_PRESET_FIELD.setItemText(0, _translate("FIND_ELEMENT_WIDGET", "Avg. Low Frequency"))
        self.FREQANG_PRESET_FIELD.setItemText(1, _translate("FIND_ELEMENT_WIDGET", "Freq 2"))
        self.FREQANG_PRESET_FIELD.setItemText(2, _translate("FIND_ELEMENT_WIDGET", "Freq 3"))
