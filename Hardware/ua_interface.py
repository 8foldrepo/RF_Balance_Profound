...
if __name__ == "__main__":
    ...
    print(data)
    #
    # wtf.write_data(['1', 'GD0439', '20200609', '1', '4.18', '13.38', '-87.9', '65.4', '63.3', '63.7', '65.2', '68.0', '78.8', '66.3', '63.4', '74.3', '65.2', '38.2', '35.7', '38.3', '38.9', '39.1', '41.4', '35.6', '37.0', '30.2', '34.7'])
    #
